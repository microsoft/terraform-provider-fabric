...
subcategory: ""
description: |-
  List a Fabric Workspace Managed Private Endpoints.
  Use this data source to list Workspace Managed Private Endpoints https://learn.microsoft.com/fabric/security/security-managed-private-endpoints-overview for more information.
...
- `values` (Attributes List) The list of Workspace Managed Private Endpoints. (see [below for nested schema](#nestedatt--values))
