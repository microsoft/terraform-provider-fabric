...
- `sensitivity_label_settings` (Attributes) The Mounted Data Factory sensitivity label settings. (see [below for nested schema](#nestedatt--sensitivity_label_settings))
