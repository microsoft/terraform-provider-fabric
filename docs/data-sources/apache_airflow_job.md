...
- `sensitivity_label_settings` (Attributes) The Apache Airflow Job sensitivity label settings. (see [below for nested schema](#nestedatt--sensitivity_label_settings))
