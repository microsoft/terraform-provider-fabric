...
- `sensitivity_label_settings` (Attributes) The Data Pipeline sensitivity label settings. (see [below for nested schema](#nestedatt--values--sensitivity_label_settings))
- `workspace_id` (String) The Workspace ID.
