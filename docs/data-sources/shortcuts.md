...
- `target` (Attributes) An object that contains the target datasource. (see [below for nested schema](#nestedatt--values--target))
...
- `one_drive_share_point` (Attributes) An object containing the properties of the target OneDrive for Business & SharePoint Online data source. (see [below for nested schema](#nestedatt--values--target--one_drive_share_point))
...
<a id="nestedatt--values--target--one_drive_share_point"></a>

### Nested Schema for `values.target.one_drive_share_point`
