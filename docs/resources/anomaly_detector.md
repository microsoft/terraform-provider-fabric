...
subcategory: ""
description: |-
  The Anomaly Detector resource allows you to manage a Fabric Anomaly Detector https://learn.microsoft.com/fabric/real-time-intelligence/anomaly-detection.
