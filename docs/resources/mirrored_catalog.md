...
page_title: "fabric_mirrored_catalog Resource - terraform-provider-fabric"
subcategory: ""
description: |-
  The Mirrored Catalog resource allows you to manage a Fabric Mirrored Catalog https://learn.microsoft.com/fabric/database/mirrored-catalog/overview.
  -> This resource supports Service Principal authentication.
  ~> This resource is in preview. To access it, you must explicitly enable the preview mode in the provider level configuration.
---

# fabric_mirrored_catalog (Resource)
