...
page_title: "fabric_operations_agent Resource - terraform-provider-fabric"
subcategory: ""
description: |-
  The Operations Agent resource allows you to manage a Fabric Operations Agent https://learn.microsoft.com/fabric/real-time-intelligence/operations-agent.
  -> This resource does not support Service Principal. Please use a User context authentication.
  ~> This resource is in preview. To access it, you must explicitly enable the preview mode in the provider level configuration.
---

# fabric_operations_agent (Resource)
