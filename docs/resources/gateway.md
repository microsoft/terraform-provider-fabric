...
- `max_member_gateway_count` (Number) The maximum number of member gateways to scale up to. Value must be between 1 and 9. If the value of [`type`](#type) attribute is one of `OnPremises` or `OnPremisesPersonal` this attribute is **NULL**. If the [`number_of_member_gateways`](#number_of_member_gateways) attribute is set this attribute is **NULL**. If the [`min_member_gateway_count`](#min_member_gateway_count) attribute is set this attribute is **REQUIRED**. Value must be at least sum of min_member_gateway_count.
- `min_member_gateway_count` (Number) The minimum number of member gateways to scale down to. Value must be between 1 and 9. If the value of [`type`](#type) attribute is one of `OnPremises` or `OnPremisesPersonal` this attribute is **NULL**. If the [`number_of_member_gateways`](#number_of_member_gateways) attribute is set this attribute is **NULL**. If the [`max_member_gateway_count`](#max_member_gateway_count) attribute is set this attribute is **REQUIRED**.
- `number_of_member_gateways` (Number) The number of member gateways. Value must be between 1 and 9. If the value of [`type`](#type) attribute is one of `OnPremises` or `OnPremisesPersonal` this attribute is **NULL**. If the [`min_member_gateway_count`](#min_member_gateway_count) attribute is set this attribute is **NULL**. If the [`max_member_gateway_count`](#max_member_gateway_count) attribute is set this attribute is **NULL**.
