...
page_title: "fabric_eventstream_destination_connection Ephemeral Resource - terraform-provider-fabric"
subcategory: ""
description: |-
  The Eventstream Destination Connection ephemeral resource allows you to manage a temporary Fabric Eventstream Destination Connection https://learn.microsoft.com/fabric/real-time-intelligence/event-streams/overview.
...
# fabric_eventstream_destination_connection (Ephemeral Resource)
...
- `consumer_group_name` (String) The consumer group name.
