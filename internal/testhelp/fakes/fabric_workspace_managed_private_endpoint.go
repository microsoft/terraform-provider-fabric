...
func (o *operationsWorkspaceManagedPrivateEndpoint) Create(data fabcore.CreateManagedPrivateEndpointRequest) fabcore.ManagedPrivateEndpoint {
	...
	entity.ConnectionState.Description = data.RequestMessage
...
func (o *operationsWorkspaceManagedPrivateEndpoint) Filter(entities []fabcore.ManagedPrivateEndpoint, parentID string) []fabcore.ManagedPrivateEndpoint {
...
func (o *operationsWorkspaceManagedPrivateEndpoint) Update(base fabcore.ManagedPrivateEndpoint, data fabcore.ManagedPrivateEndpoint) fabcore.ManagedPrivateEndpoint {
	base = data
