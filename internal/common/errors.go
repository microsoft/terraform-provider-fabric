...
const (
	...
	WarningPreviewModeDetails          = "The '%s' behavior may change in future releases without notice or compatibility guarantees. Please report any issues to the provider developers."
)
