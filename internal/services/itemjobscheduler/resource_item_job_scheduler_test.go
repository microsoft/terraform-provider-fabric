	...
	resource.Test(t, testhelp.NewTestUnitCase(t, &testResourceItemFQN, fakes.FakeServer.ServerFactory, nil, []resource.TestStep{
		// Create and Read
		{
			...
			Check: resource.ComposeAggregateTestCheckFunc(
				...
				resource.TestCheckResourceAttr(testResourceItemFQN, "configuration.local_time_zone_id", itemjobscheduler.DefaultLocalTimeZoneID),
		...
		// Update and Read
		{
			...
			Config: at.CompileConfig(
				...
				map[string]any{
					...
					"configuration": map[string]any{
						...
						"local_time_zone_id": testLocalTimeZoneID,
			...
			Check: resource.ComposeAggregateTestCheckFunc(
				...
				resource.TestCheckResourceAttr(testResourceItemFQN, "configuration.local_time_zone_id", testLocalTimeZoneID),
