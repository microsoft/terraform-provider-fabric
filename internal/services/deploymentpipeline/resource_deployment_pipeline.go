...
func (r *resourceDeploymentPipeline) get(ctx context.Context, model *resourceDeploymentPipelineModel) diag.Diagnostics {
	respGet, err := r.client.GetDeploymentPipeline(ctx, model.ID.ValueString(), nil)
