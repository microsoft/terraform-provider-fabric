...
func NewResourceVariableLibrary() resource.Resource {
	propertiesSetter := func(ctx context.Context, from *fabvariablelibrary.Properties, to *fabricitem.ResourceFabricItemPropertiesModel[variablelibraryPropertiesModel, fabvariablelibrary.Properties]) diag.Diagnostics {
	...
	config := fabricitem.ResourceFabricItemProperties[variablelibraryPropertiesModel, fabvariablelibrary.Properties]{
