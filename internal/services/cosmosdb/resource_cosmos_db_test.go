...
var testHelperLocals = at.CompileLocalsConfig(map[string]any{
	"path": testhelp.GetFixturesDirPath("cosmos_db"),
})

func TestUnit_CosmosDBResource_Attributes(t *testing.T) {
...
func TestUnit_CosmosDBResource_ImportState(t *testing.T) {
...
func TestUnit_CosmosDBResource_CRUD(t *testing.T) {
	workspaceID := testhelp.RandomUUID()
...
func TestAcc_CosmosDBResource_CRUD(t *testing.T) {
...
func TestAcc_CosmosDBDefinitionResource_CRUD(t *testing.T) {
	workspace := testhelp.WellKnown()["WorkspaceRS"].(map[string]any)
	workspaceID := workspace["id"].(string)
