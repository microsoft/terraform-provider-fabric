...
func TestUnit_OrgAppDataSource(t *testing.T) {
	...
	resource.ParallelTest(t, testhelp.NewTestUnitCase(t, nil, fakes.FakeServer.ServerFactory, nil, []resource.TestStep{
		...
		// read by id
		{
			...
			Check: resource.ComposeAggregateTestCheckFunc(
				...
				resource.TestCheckResourceAttrPtr(testDataSourceItemFQN, "properties.onelake_root_path", entity.Properties.OneLakeRootPath),
...
func TestAcc_OrgAppDataSource(t *testing.T) {
	workspace := testhelp.WellKnown()["WorkspaceDS"].(map[string]any)
	workspaceID := workspace["id"].(string)

	entity := testhelp.WellKnown()["OrgApp"].(map[string]any)
	...
	resource.ParallelTest(t, testhelp.NewTestAccCase(t, &testDataSourceItemFQN, nil, []resource.TestStep{
		// read by id
		{
			...
			Check: resource.ComposeAggregateTestCheckFunc(
				...
				resource.TestCheckResourceAttrSet(testDataSourceItemFQN, "properties.onelake_root_path"),
			),
		},
		// read by id - not found
		{
		...
		// read by id with definition
		{
			...
			Check: resource.ComposeAggregateTestCheckFunc(
				...
				resource.TestCheckResourceAttr(testDataSourceItemFQN, "description", entityDescription),
				resource.TestCheckResourceAttrSet(testDataSourceItemFQN, "properties.onelake_root_path"),
				resource.TestCheckResourceAttrSet(testDataSourceItemFQN, "definition.definition.json.content"),
			),
		},
	}))
}
