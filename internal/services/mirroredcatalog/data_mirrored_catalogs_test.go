...
func TestUnit_MirroredCatalogsDataSource(t *testing.T) {
	...
	resource.ParallelTest(t, testhelp.NewTestUnitCase(t, nil, fakes.FakeServer.ServerFactory, nil, []resource.TestStep{
		...
		// read
		{
			...
			Check: resource.ComposeAggregateTestCheckFunc(
				...
				resource.TestCheckResourceAttrSet(testDataSourceItemsFQN, "values.1.properties.connection_id"),
				resource.TestCheckResourceAttrSet(testDataSourceItemsFQN, "values.1.properties.onelake_tables_path"),
				resource.TestCheckResourceAttrSet(testDataSourceItemsFQN, "values.1.properties.source_type"),
