	...
	resource.Test(t, testhelp.NewTestUnitCase(t, &testResourceItemFQN, fakes.FakeServer.ServerFactory, nil, []resource.TestStep{
		...
		// Create and Read
		{
			...
			Check: resource.ComposeAggregateTestCheckFunc(
				...
				resource.TestCheckResourceAttrSet(testResourceItemFQN, "properties.earliest_restore_point"),
				resource.TestCheckResourceAttrSet(testResourceItemFQN, "properties.latest_restore_point"),
			),
		},
