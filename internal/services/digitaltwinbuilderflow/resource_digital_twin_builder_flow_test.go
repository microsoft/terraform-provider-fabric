...
var testHelperLocals = at.CompileLocalsConfig(map[string]any{
	"path": testhelp.GetFixturesDirPath("digital_twin_builder_flow"),
})
...
var testHelperDefinition = map[string]any{
	`"definition.json"`: map[string]any{
		...
		"tokens": map[string]any{
			"DIGITAL_TWIN_BUILDER_ID": digitalTwinBuilderID,
		},
	},
}

func TestUnit_DigitalTwinBuilderFlowResource_Attributes(t *testing.T) {
