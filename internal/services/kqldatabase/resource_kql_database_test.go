	...
	resource.Test(t, testhelp.NewTestAccCase(t, &testResourceItemFQN, nil, []resource.TestStep{
		...
		// Add tags and Read
		{
			...
			Config: at.JoinConfigs(
				...
				at.CompileConfig(
					...
					map[string]any{
						...
						"tags": map[string]string{
							`"` + testhelp.RefByFQN(tagResourceFQN1, "display_name") + `"`: testhelp.RefByFQN(tagResourceFQN1, "id"),
							`"` + testhelp.RefByFQN(tagResourceFQN2, "display_name") + `"`: testhelp.RefByFQN(tagResourceFQN2, "id"),
						},
					},
				),
			),
			Check: resource.ComposeAggregateTestCheckFunc(
				...
				resource.TestCheckResourceAttrSet(testResourceItemFQN, "properties.query_service_uri"),
				resource.TestCheckResourceAttr(testResourceItemFQN, "tags.%", "2"),
				resource.TestCheckResourceAttrPair(testResourceItemFQN, "tags."+testhelp.RefByFQN(tagResourceFQN1, "display_name"), tagResourceFQN1, "id"),
				resource.TestCheckResourceAttrPair(testResourceItemFQN, "tags."+testhelp.RefByFQN(tagResourceFQN2, "display_name"), tagResourceFQN2, "id"),
			),
		},
		// Update, Remove and add tags and Read
		{
			...
			Config: at.JoinConfigs(
				...
				at.CompileConfig(
					...
					map[string]any{
						...
						"tags": map[string]string{
							`"` + testhelp.RefByFQN(tagResourceFQN1, "display_name") + `"`: testhelp.RefByFQN(tagResourceFQN1, "id"),
							`"` + testhelp.RefByFQN(tagResourceFQN3, "display_name") + `"`: testhelp.RefByFQN(tagResourceFQN3, "id"),
						},
					},
				),
			),
			Check: resource.ComposeAggregateTestCheckFunc(
				...
				resource.TestCheckResourceAttr(testResourceItemFQN, "tags.%", "2"),
				resource.TestCheckResourceAttrPair(testResourceItemFQN, "tags."+testhelp.RefByFQN(tagResourceFQN1, "display_name"), tagResourceFQN1, "id"),
				resource.TestCheckResourceAttrPair(testResourceItemFQN, "tags."+testhelp.RefByFQN(tagResourceFQN3, "display_name"), tagResourceFQN3, "id"),
			),
		},
		// Update, Remove and add tags and Read
		{
