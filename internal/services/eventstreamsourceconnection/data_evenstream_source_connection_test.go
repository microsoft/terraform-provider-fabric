	...
	resource.ParallelTest(t, testhelp.NewTestUnitCase(t, nil, fakes.FakeServer.ServerFactory, nil, []resource.TestStep{
		...
		// read
		{
			...
			Check: resource.ComposeAggregateTestCheckFunc(
				...
				resource.TestCheckResourceAttrPtr(testDataSourceItemFQN, "access_keys.secondary_connection_string", entity.SourceConnectionResponse.AccessKeys.SecondaryConnectionString),
				resource.TestCheckResourceAttrPtr(testDataSourceItemFQN, "access_keys.primary_key", entity.SourceConnectionResponse.AccessKeys.PrimaryKey),
				resource.TestCheckResourceAttrPtr(testDataSourceItemFQN, "access_keys.secondary_key", entity.SourceConnectionResponse.AccessKeys.SecondaryKey),
			),
		},
	}))
}
