...
func TestUnit_WarehouseSnapshotDataSource(t *testing.T) {
	...
	resource.ParallelTest(t, testhelp.NewTestUnitCase(t, nil, fakes.FakeServer.ServerFactory, nil, []resource.TestStep{
		...
		// read by name
		{
			...
			Check: resource.ComposeAggregateTestCheckFunc(
				...
				resource.TestCheckResourceAttrSet(testDataSourceItemFQN, "properties.snapshot_date_time"),
				resource.TestCheckResourceAttrSet(testDataSourceItemFQN, "properties.parent_warehouse_id"),
			),
		},
...
func TestAcc_WarehouseSnapshotDataSource(t *testing.T) {
	workspace := testhelp.WellKnown()["WorkspaceDS"].(map[string]any)
	workspaceID := workspace["id"].(string)

	entity := testhelp.WellKnown()["WarehouseSnapshot"].(map[string]any)
